-- java-ci-library main module.
--
-- Generates GitHub Actions CI workflows for Java Maven service archetypes:
...
--
-- Uses p6m-actions: java-maven-setup@v1, java-maven-build@v1, java-maven-cut-tag@v1
--
